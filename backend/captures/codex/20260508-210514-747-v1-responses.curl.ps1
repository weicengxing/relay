$bodyPath = 'D:\relay\backend\captures\codex\20260508-210514-747-v1-responses.body.json'
curl.exe -N 'http://localhost:8080/v1/responses' `
  -H 'x-codex-beta-features: terminal_resize_reflow' `
  -H 'x-codex-turn-metadata: {"session_id":"019e06a5-1b02-7f50-8a08-ae2c1a2c529b","thread_source":"user","turn_id":"019e07b1-3565-7c11-91e4-66ca1dadd0d9","sandbox":"windows_elevated","turn_started_at_unix_ms":1778245514710}' `
