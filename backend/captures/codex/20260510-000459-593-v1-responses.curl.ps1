$bodyPath = 'D:\relay\backend\captures\codex\20260510-000459-593-v1-responses.body.json'
curl.exe -N 'http://api.relaywei.ccwu.cc/v1/responses' `
  ...
  -H 'X-Codex-Turn-Metadata: {"session_id":"019e0d78-4849-74e1-90a8-1ac1138acf65","thread_source":"user","turn_id":"019e0d7b-35bc-79a0-a606-5591ac121b9d","sandbox":"windows_elevated","turn_started_at_unix_ms":1778342639050}' `
