$bodyPath = 'D:\relay\backend\captures\codex\20260510-104530-696-v1-responses.body.json'
curl.exe -N 'http://api.relaywei.ccwu.cc/v1/responses' `
  ...
  -H 'Cf-Ipcountry: SG' `
  -H 'Cf-Ray: 9f959baa1820ff96-SIN' `
  -H 'Cf-Visitor: {"scheme":"https"}' `
  -H 'Cf-Warp-Tag-Id: b45a3ab4-8306-4cd3-a1b3-7637d46e1dae' `
  -H 'Content-Type: application/json' `
  -H 'Originator: Codex Desktop' `
  -H 'Session_id: 019e0fc6-378c-74f3-8534-2dd3e3b0b76e' `
  -H 'X-Client-Request-Id: 019e0fc6-378c-74f3-8534-2dd3e3b0b76e' `
  -H 'X-Codex-Beta-Features: terminal_resize_reflow' `
  -H 'X-Codex-Turn-Metadata: {"session_id":"019e0fc6-378c-74f3-8534-2dd3e3b0b76e","thread_source":"user","turn_id":"019e0fc6-37aa-7083-8079-64fda8783b04","sandbox":"windows_elevated","turn_started_at_unix_ms":1778381109165}' `
  -H 'X-Codex-Window-Id: 019e0fc6-378c-74f3-8534-2dd3e3b0b76e:0' `
