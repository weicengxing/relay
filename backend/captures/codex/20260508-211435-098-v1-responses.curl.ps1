$bodyPath = 'D:\relay\backend\captures\codex\20260508-211435-098-v1-responses.body.json'
curl.exe -N 'http://localhost:8080/v1/responses' `
  -H 'x-codex-beta-features: terminal_resize_reflow' `
  -H 'x-codex-turn-metadata: {"session_id":"019e06a5-1b02-7f50-8a08-ae2c1a2c529b","thread_source":"user","turn_id":"019e07b9-c26a-7150-8ca7-3b74363a44a9","sandbox":"windows_elevated","turn_started_at_unix_ms":1778246075052}' `
