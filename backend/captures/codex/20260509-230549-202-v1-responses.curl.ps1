$bodyPath = 'D:\relay\backend\captures\codex\20260509-230549-202-v1-responses.body.json'
curl.exe -N 'http://api.relaywei.ccwu.cc/v1/responses' `
  ...
  -H 'Cf-Ipcountry: CN' `
  -H 'Cf-Ray: 9f919ac1e9c804cf-HKG' `
  -H 'Cf-Visitor: {"scheme":"http"}' `
  -H 'Cf-Warp-Tag-Id: 929132cd-2637-4154-a5d1-78aaa6b3466d' `
  -H 'Content-Type: application/json' `
  -H 'Originator: Codex Desktop' `
  -H 'X-Client-Request-Id: codex-xiaomi-cleanup-smoke-3' `
  -H 'X-Codex-Window-Id: codex-xiaomi-cleanup-smoke-3:0' `
