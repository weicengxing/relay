$bodyPath = 'D:\relay\backend\captures\codex\20260510-110538-226-v1-responses.body.json'
curl.exe -N 'http://api.relaywei.ccwu.cc/v1/responses' `
  ...
  -H 'X-Codex-Turn-Metadata: {"session_id":"019e0fd5-1198-7a31-a210-74b6079fc1ef","thread_source":"user","turn_id":"019e0fd8-e71d-74a1-9a2d-74e476be57f8","sandbox":"windows_elevated","turn_started_at_unix_ms":1778382333748}' `
