$bodyPath = 'D:\relay\backend\captures\codex\20260508-210028-788-v1-responses.body.json'
curl.exe -N 'http://localhost:8080/v1/responses' `
  -H 'x-codex-beta-features: terminal_resize_reflow' `
  -H 'x-codex-turn-metadata: {"session_id":"019e07ac-c3bb-71a0-9cad-2ced6ecb0f57","thread_source":"user","turn_id":"019e07ac-c4cd-7450-be05-0e4af781e3c1","sandbox":"windows_elevated","turn_started_at_unix_ms":1778245223724}' `
