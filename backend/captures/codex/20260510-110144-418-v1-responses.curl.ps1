$bodyPath = 'D:\relay\backend\captures\codex\20260510-110144-418-v1-responses.body.json'
curl.exe -N 'http://api.relaywei.ccwu.cc/v1/responses' `
  ...
  -H 'X-Codex-Turn-Metadata: {"session_id":"019e0fd5-1198-7a31-a210-74b6079fc1ef","thread_source":"user","turn_id":"019e0fd5-63eb-78d2-8acb-cde389fe97ff","sandbox":"windows_elevated","turn_started_at_unix_ms":1778382103590}' `
